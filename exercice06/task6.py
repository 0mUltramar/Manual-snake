...
# считаем, сколько всего итераций потребовалось, чтобы найти удовл. условию знчения
totalIter = sum(iterList)


for i in range(7):  # Задаем ограничение на 6 значений
